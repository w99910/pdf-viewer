...
export default class PDFViewer {
    ...
    protected initialisePDFService() {
        ...
        this.pdfScriptingManager = new pdfjsViewer.PDFScriptingManager({
            eventBus: this.eventBus,
            sandboxBundleSrc: pdfjsSandboxUrl,
        });
    ...
    protected buildContainers() {
        ...
        this.buttonsContainer.className = "w-full grid grid-cols-3 gap-x-2 rounded items-center border shadow-lg p-1 bg-white";
        ...
        this.bodyContainer.className = "w-full h-full mt-2 relative overflow-y-auto flex justify-center";
